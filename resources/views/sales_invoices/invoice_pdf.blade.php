...
.doc-num   { font-size: 12px; font-weight: 700; color: #2563eb; text-align: right; font-family: "Courier New", monospace; margin-top: 3px; }
...
<table class="bts"><tr>
    <td style="width:48%; padding-right:20px">
        <div class="section-lbl">Facture a</div>
        <div class="party-name">{{ $invoice->client->nom }}</div>
        <div class="party-detail">
            @if($invoice->client->email){{ $invoice->client->email }}<br>@endif
            @if($invoice->client->telephone)Tel : {{ $invoice->client->telephone }}<br>@endif
            @if($invoice->client->adresse){{ $invoice->client->adresse }}<br>@endif
            @if($invoice->client->ville){{ $invoice->client->ville }}@endif
        </div>
    </td>
    <td style="width:52%">
...
<table class="pay">
    ...
    <tfoot><tr>
        <td colspan="4" style="text-align:right">Total encaisse :</td>
