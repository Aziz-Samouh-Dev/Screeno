...
export default function InvoiceForm({
    ...
    const handleProductChange = (index: number, productId: string) => {
        ...
        // reset qty to 1 when product changes to avoid accidental over-stock
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 w-full">
            ...
            <section className="space-y-4">
                ...
                {anyOverStock && (
                    <div className="flex items-center gap-2 rounded-lg bg-red-50 border border-red-200 px-4 py-3 text-sm text-red-700">
                        ...
                        Some items exceed available stock. Quantities have been capped automatically.
                    </div>
                )}
                            ...
                            {fields.map((field, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* Line total */}
                                        <td className="px-4 py-2 text-right font-semibold text-slate-900 font-mono">
            ...
            <div className="flex justify-end">
                <Button type="submit" disabled={processing || anyOverStock}>
